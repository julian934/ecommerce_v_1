...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900  flex md:col-start-2 md:row-start-1 md:justify-around md:col-span-2 md:max-h-32  md:w-full ">
    <div className="max-w-screen-xl max-h-screen-xl flex flex-wrap justify-end items-center md:gap-x-6 justify-between mx-auto p-4">
      <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">NuThread By Julian</span>
      </Link>
